...
namespace AJZ.FCL.Data
{
    ...
    public interface IRepository<TEntity> : IDisposable
    {
        ...
        int Update(Expression<Func<TEntity, TEntity>> updateExpression, Expression<Func<TEntity, bool>> filterExpression);
        ...
        /// <returns></returns>
        TEntity First(Expression<Func<TEntity, bool>> expression, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderByExpression = null);
        ...
        IPagedList<TEntity> GetPagedList(int pageIndex, int pageSize, Expression<Func<TEntity, bool>> expression, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderByExpression);

        IPagedList<TEntity> GetPagedList(SearchBase search, Expression<Func<TEntity, bool>> expression, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderByExpression);
        ...
        /// <param name="orderByExpression"> </param>
        /// <returns>List of selected elements</returns>
        //IEnumerable<TEntity> GetFiltered(Expression<Func<TEntity, bool>> filter, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderByExpression = null);
